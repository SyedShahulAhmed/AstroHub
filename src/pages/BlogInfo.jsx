  ...
  return (
    <div className='max-w-[1240px] mx-auto my-8'>
        <div className='w-[70%] mx-auto'>
            <img src={blog.image} alt="" className='w-full object-cover shadow-2xl  rounded-md hover:scale-105 transition-all duration-300'/>
        </div>
        ...
        <div className='flex justify-between items-center px-2 md:px-5 my-5'>
